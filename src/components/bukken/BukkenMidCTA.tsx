...
export default function BukkenMidCTA() {
  return (
    <section style={{ background: "#fff", padding: "48px 24px", textAlign: "center" }}>
      <p style={{ fontSize: "clamp(14px, 2.5vw, 16px)", fontWeight: 500, color: "#555", marginBottom: "8px", lineHeight: 1.7 }}>
        ここまで読んで気になった方へ
      </p>
      ...
      <a
        ...
        onClick={() => { window.dataLayer?.push({ event: "line_cta_click", cta_location: "bukken_mid_cta" }); }}
        style={{
          display: "inline-flex",
          alignItems: "center",
          gap: "10px",
