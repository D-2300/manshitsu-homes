...
export default function V3ExitPopup() {
  ...
  const handleExit = useCallback(() => {
    ...
    setShow(true);
    window.dataLayer?.push({ event: "exit_popup_shown", location: "manshitsu_v3" });
  }, [dismissed]);
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          zIndex: 9998,
          animation: "v3PopupFadeIn 0.2s ease",
        }}
      />
      ...
      <div
        style={{
          ...
          animation: "v3PopupSlideUp 0.3s ease",
        }}
      >
        <button
          onClick={handleDismiss}
      ...
      <style>{`
        @keyframes v3PopupFadeIn {
          from { opacity: 0; }
          to { opacity: 1; }
        }
        @keyframes v3PopupSlideUp {
