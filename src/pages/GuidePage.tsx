  ...
  return (
    <div className="guide-root">
      ...
      <article className="page">
        ...
        <p>加えて、物件情報は<strong>売主様からお預かりした信頼の上に成り立って流通しているもの</strong>です。そのため弊社では、<strong>買う意思の明確なお客様に限定</strong>して情報をお渡ししています。情報収集のみを目的とされている場合には対応できない旨、ご理解いただけますと幸いです。</p>
